##############################################
User Guide Appendix |hyphen| Desktop Solutions
##############################################
...
.. only:: latex
    ...
    This user guide is also availabe online at 
    `docs.cronologic.de/projects/tbt2pcie
    <https://docs.cronologic.de/projects/tbt2pcie/en/latest/>`_.


The user guides of all products by cronologic GmbH & Co. KG
are available online at `docs.cronologic.de <https://docs.cronologic.de/>`__.
